...
function flag1(){//ボタン１が押された
    flag = 1;
    document.getElementById("flag").textContent = "1";
    console.log("flag = 1");
}
function flag2(){//ボタン２が押された
    flag = 2;
    document.getElementById("flag").textContent = "2";
    console.log("flag = 2");
}
function flag3(){//ボタン３が押された
    flag = 3;
    document.getElementById("flag").textContent = "3";
    console.log("flag = 3");
}

function TextFunc() {//テキストの制御
